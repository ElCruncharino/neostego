...
public class AdaptiveCmdTest {
    ...
    public void v2RoundTripAcrossPayloadsAndMu() throws Exception {
        ...
        for (double mu : mus) {
            for (int len : payloads) {
                ...
                byte[] stego = newStego(true, mu, false, null)
                        .embedData(msg, "m.bin", coverBytes, "cover.png", "stego.png");
                ...
                assertArrayEquals(msg, (byte[]) out.get(1),
                        "v2 round-trip must be lossless (mu=" + mu + ", len=" + len + ")");
            }
        }
    }
    ...
    public void v2EncryptedRoundTrip() throws Exception {
        ...
        byte[] stego = newStego(true, 9.0, true, pw)
                .embedData(msg, "secret.bin", coverBytes, "cover.png", "stego.png");
    ...
    public void v1StegoStillDecodesOnV2AwareBuild() throws Exception {
        ...
        byte[] stego = newStego(false, 9.0, false, null)
                .embedData(msg, "old.txt", coverBytes, "cover.png", "stego.png");
        List<?> out = newStego(false, 9.0, false, null).extractData(stego, "stego.png");
    ...
    public void v2EmbeddingChangesChannelsByAtMostOne() throws Exception {
        ...
        byte[] stego = newStego(true, 9.0, false, null)
                .embedData(msg, "m.bin", coverBytes, "cover.png", "stego.png");
            ...
            for (int y = 0; y < h; y++) {
                ...
                for (int ch = 0; ch < 3; ch++) {
                    ...
                    assertTrue(Math.abs(cv - sv) <= 1,
                            "Each channel must change by at most 1; got " + cv + " -> " + sv);
                }
            }
        }
    }
    ...
    public void v2RoundTripOnSaturatedCovers() throws Exception {
        ...
        for (int rgb : new int[] {0x000000, 0xFFFFFF}) {
            ...
            byte[] stego = newStego(true, 9.0, false, null)
                    .embedData(msg, "m.bin", cover, "flat.png", "stego.png");
